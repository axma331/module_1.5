...
public class OzonProductCardBuilder extends ProductCardBuilder {
    ...
    protected void setMarketplaceName() {
        parameters.put("marketplaceName", "Ozon");
    }

    @Override
    protected void buildSalePrice() {
        parameters.put("salePrice", String.valueOf(procurementPrice * 3));
    }
}
